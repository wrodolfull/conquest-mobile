...
interface Props { activeActivity?: ActiveActivitySession; selectedTerritory: MapTerritory | null; onTerritorySelectionChange: (territory: MapTerritory | null) => void }
...
export function ConquestMap({ activeActivity, selectedTerritory, onTerritorySelectionChange }: Props) {

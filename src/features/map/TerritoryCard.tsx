    ...
    <Animated.View style={[
      ...
      <View style={styles.actions}>
        ...
        <Pressable
          ...
          style={[styles.challenge, !canChallenge && styles.challengeDisabled]}
        >
          <Ionicons name="flash" size={14} color={colors.background} />
          <Text style={styles.challengeText}>CHALLENGE OWNER</Text>
        </Pressable>
      </View>
    </Animated.View>
  );
...
const styles = StyleSheet.create({
  card: { position: 'absolute', left: 12, right: 12, bottom: 12, minHeight: 190, padding: 18, borderRadius: 20, backgroundColor: '#0A1512F2', borderWidth: 1, borderColor: '#52665F', shadowColor: '#000', shadowOpacity: 0.45, shadowRadius: 16, shadowOffset: { width: 0, height: 6 }, elevation: 12 },
  ...
  stats: { flexDirection: 'row', marginTop: 16, gap: 7 }, stat: { flex: 1 }, label: { color: colors.muted, fontSize: 6.5, fontWeight: '900', letterSpacing: 0.5 }, value: { color: colors.text, fontSize: 11, fontWeight: '800', marginTop: 4 }, accent: { color: colors.gold },
  actions: { flexDirection: 'row', gap: 8, marginTop: 18 }, secondary: { flex: 1, height: 42, borderRadius: 11, borderWidth: 1, borderColor: '#52665F', alignItems: 'center', justifyContent: 'center' }, secondaryText: { color: colors.text, fontSize: 9, fontWeight: '900', letterSpacing: 0.6 },
  challenge: { flex: 1.15, height: 42, borderRadius: 11, backgroundColor: colors.lime, flexDirection: 'row', gap: 4, alignItems: 'center', justifyContent: 'center' }, challengeDisabled: { opacity: 0.45 }, challengeText: { color: colors.background, fontSize: 8.5, fontWeight: '900', letterSpacing: 0.4 },
});

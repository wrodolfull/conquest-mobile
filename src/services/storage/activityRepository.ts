...
export const activityRepository={
 async removeForOwner(ownerUserId:string){const db=await database();await db.runAsync('DELETE FROM completed_activities WHERE owner_user_id=?',ownerUserId);influence.clear();notify();},
